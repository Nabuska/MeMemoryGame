 ...
 */
public class NyanCard extends BasicCard {
    public static final int IMAGE_NUMBER = 8;
    private Animation pareFoundAnim;

    public NyanCard(Collection<BasicCard> cards, Activity activity) {
        super(cards, activity);
        pareFoundAnim = AnimationUtils.loadAnimation(activity, R.anim.poistuu_oik);
    }

 ...
 */
public class RageCard extends BasicCard {
    public static final int IMAGE_NUMBER = 11;
    private Animation pareFoundAnim;

    public RageCard(Collection<BasicCard> cards, Activity activity) {
        super(cards, activity);
        pareFoundAnim = AnimationUtils.loadAnimation(activity, R.anim.agre_heil);
    }

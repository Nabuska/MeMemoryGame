 ...
 */
public class TrollCard extends BasicCard {
    public static final int IMAGE_NUMBER = 13;
    private Animation pareFoundAnim;

    public TrollCard(Collection<BasicCard> cards, Activity activity) {
        super(cards, activity);
        pareFoundAnim = AnimationUtils.loadAnimation(activity, R.anim.threesixty);
    }

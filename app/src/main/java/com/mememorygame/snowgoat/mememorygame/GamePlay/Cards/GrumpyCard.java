 ...
 */
public class GrumpyCard extends BasicCard {
    public static final int IMAGE_NUMBER = 3;
    private Animation pareFoundAnim;

    public GrumpyCard(Collection<BasicCard> cards, Activity activity) {
        super(cards, activity);
        pareFoundAnim = AnimationUtils.loadAnimation(activity, R.anim.laskeutuva);
    }

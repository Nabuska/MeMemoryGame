...
/**
 * Created by joona on 01/12/2015.
 */
public class ForeverAloneCard extends BasicCard {
    public static final int IMAGE_NUMBER = 2;
    private Animation pareFoundAnim;

    public ForeverAloneCard(Collection<BasicCard> cards, Activity activity) {
        super(cards, activity);
        pareFoundAnim = AnimationUtils.loadAnimation(activity, R.anim.pienenee);
    }

 ...
 */
public class PepeCard extends BasicCard {
    public static final int IMAGE_NUMBER = 10;
    private Animation pareFoundAnim;

    public PepeCard(Collection<BasicCard> cards, Activity activity) {
        super(cards, activity);
        pareFoundAnim = AnimationUtils.loadAnimation(activity, R.anim.suurenee);
    }
